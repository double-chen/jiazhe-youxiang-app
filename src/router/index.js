import { StackNavigator as StackNav, createBottomTabNavigator as TabNav } from 'react-navigation';
...
import MinePage from '../pages/main/MinePage';

export const TabNavigator = TabNav({
  HomePage: {
    screen: HomePage,
  },
  OrderPage: {
